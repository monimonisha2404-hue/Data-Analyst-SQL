...
call gethighbillingpatients();
 ...
 -- 21) using limit and offset.display first 5 patients from the patients table.
 select*from patients limit 5;
 
 -- skip the first 5 patients and display the next 5 patients.
 select*from patients limit 5 offset 5;

-- 22) return rows where there in a a match in both tables.
